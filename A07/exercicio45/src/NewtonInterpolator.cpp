...
void NewtonInterpolator::Draw(string title,string x_axis, string y_axis, Int_t npx)
{
  if(Nplots == 0)
  {
...
void NewtonInterpolator::PrintPlot(string filename,string title,string x_axis, string y_axis, Int_t npx)
{

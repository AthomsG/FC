...
class NevilleInterpolator : public DataPoints
{
  public:
    ...
    ~NevilleInterpolator() {delete FInterpolator; delete F0;}
    ...
    void PrintPlot(string filename = "Neville.eps",string title = "",string x = "",string y = "", Int_t npx = 500); // print results to file (optional)
  private:
